...
public abstract class AbstractCacheSupport implements CacheSupport {
    ...
    public void registerInvocation(Object targetBean, Method targetMethod, Class[] invocationParamTypes,
        ...
        for (Cache cache : caches) {
            registerCache(cache, invocation);
        }
    }
     ...
     * @param cache
     */
    public abstract void registerCache(Cache cache, CachedMethodInvocation invocation);
    ...
    protected Object generateKey(Collection<? extends Cache> caches, String key, Method method, Object[] args,
        ...
        return this.getKeyGenerator().generate(target, method, args);
    }
    ...
    public void refreshCacheByKey(String cacheName, String cacheKey) {
        ...
        //在redis拿到方法信息，然后刷新缓存
        Object result = getRedisTemplate().opsForValue().get(getInvocationCacheKey(cacheKey));
     ...
     * @return
     */
    protected abstract String getInvocationCacheKey(String cacheKey);
     ...
     * @param cache
     */
    protected abstract void refreshCache(Cache cache, CachedMethodInvocation invocation);
