...
import org.chance.cache.layering.LayeringCacheSupportImpl;
...
public class CachingAnnotationsAspect {
    ...
    public CachingAnnotationsAspect() {
        logger.debug("CachingAnnotationsAspect 初始化");
    }
