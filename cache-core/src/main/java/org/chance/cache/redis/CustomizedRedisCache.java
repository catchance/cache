...
import org.chance.cache.util.ThreadTaskUtils;
 ...
 * @date 2018-08-08 17:28:30
 */

public class CustomizedRedisCache extends RedisCache {

    private static final Logger log = LoggerFactory
        .getLogger(CustomizedRedisCache.class);
    ...
    private final RedisOperations redisOperations = null;
...
//    private final byte[] prefix;
     ...
     * @param expiration
     */
//    public CustomizedRedisCache(String name, byte[] prefix, RedisOperations<?, ?> redisOperations,
